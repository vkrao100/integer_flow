...
from sympy import *
from sympy.polys.monomials import monomial_divides, monomial_lcm, term_div, monomial_mul
...
# ring = a,b,"lex"
# R, a, b = ring('a b', QQ)
# #F = [f1, f2, f3] = [8*a*b -3*a + 2*b,a**2-a,b**2-b]
# F = [8*a*b -3*a + 2*b+7,a**2-a,b**2-b]
# print(groebner(F,R,'buchberger'))


# R, a0, a1, b0, b1 = ring('a0 a1 b0 b1', QQ)
# F = [4/3*a0*a1*b0*b1-2*a0*b0*b1-2*a1*b0, a0**2-a0,b0**2-b0,a1**2-a1,b1**2-b1]
# print(groebner(F,R,'f5b'))
# print(red_groebner(F,R))

R, a0, a1, a2, b0, b1, b2 = ring('a0 a1 a2 b0 b1 b2', QQ)

F = [-44/3*a0*a1*a2*b0*b1*b2+4/3*a0*a1*a2*b0*b1+8*a0*a1*a2*b0*b2
+8/3*a0*a1*a2*b1*b2+4/3*a0*a1*b0*b1*b2-2/3*a0*a1*b0*b1+4/3*a0*a1*b1*b2
+8/3*a0*a2*b0*b1*b2-4*a0*a2*b0*b2+28/3*a1*a2*b0*b1*b2-14/3*a1*a2*b0*b1-8/3*a1*a2*b0*b2
-20/3*a1*a2*b1*b2+8/3*a1*a2*b1-2/3*a1*b1-4/3*a1*b2+1, a0**2-a0,b0**2-b0,a1**2-a1,b1**2-b1, a2**2-a2,b2**2-b2]
print(groebner(F,R,'f5b'))